...
# Nothing happens but give many error messages
# he score function isn't working properly
#   TODO 2:
#   Run this code again and click on the square a few times. Document what
#   happens in the python console. Stop the code.
# Every time it's clicked, it starts counting up from one in the console
